...
all_data_df = pd.read_csv('all_data_fake.csv')
top_click_all_pd = pd.read_csv('top_click_all.csv')
upload_project_fake = pd.read_csv('upload_project.csv')
...
class dataset_recom(object):
    def __init__(self):
        ...
        self.category_match = pd.read_csv('project_fake.csv')
...
recom_table.to_csv('dataset_recommendation.csv',index=False)